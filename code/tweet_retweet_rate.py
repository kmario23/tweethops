...
def sleeper(secs):
    ...
    print("Re/Tweet Rate Call: Sleep for ", to_mins, "mins & continue ...")
...
def present_output(usernames_set, user_batch):
    ...
    print("{0: <30} | {1: <18} | {2: <8} | {3: <8} | {4: <8} | {5: <8} | {6: <8} | {7: <8} | {8: <8} | {9: <8}".format( \
          'Search Query', 'Username', 'Followrs', 'Friends', 'Tweet-cnt', 'Twt_span', 'Twt_rate', 'Retwt-cnt', 'Rtwt_span' , 'Rtwt_rate') \
          )
    print("*"*150)
